...
```bash
npx -y github:shanye1402-hash/hotbee-api-skills#v1.0.0 call seedance --prompt "<video prompt>"
```

Query a task:

```bash
npx -y github:shanye1402-hash/hotbee-api-skills#v1.0.0 call seedance --task-id "<task_id>"
```
