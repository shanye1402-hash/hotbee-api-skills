...
```bash
npx -y github:shanye1402-hash/hotbee-api-skills#v1.0.1 call image2 --prompt "<prompt>"
```

Dry-run before spending points unless the user clearly asks to execute:

```bash
npx -y github:shanye1402-hash/hotbee-api-skills#v1.0.1 call image2 --dry-run --prompt "生成一张小红书封面"
```
